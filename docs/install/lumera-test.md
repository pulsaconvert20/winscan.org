...
curl -Ls https:/-lumera.winnode.xyz/genesis > $HOME/.lumera-test/config/genesis.json

# Verify genesis
$(basename https://github.com/LumeraProtocol/lumera-networks .git || chainName)d validate-genesis
```
