...
curl -Ls https://rest.uptick.network/genesis > $HOME/.uptick-mainnet/config/genesis.json

# Verify genesis
$(basename https://github.com/UptickNetwork/uptick .git || chainName)d validate-genesis
```
