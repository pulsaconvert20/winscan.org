...
```bash
mkdir -p $HOME/.osmosis/cosmovisor/upgrades/upgrade-28.0.0/bin
```
...
tar -xzf osmosisd.tar.gz
chmod +x osmosisd
mv osmosisd $HOME/.osmosis/cosmovisor/upgrades/upgrade-28.0.0/bin/
```

### 3. Verify Binary

```bash
$HOME/.osmosis/cosmovisor/upgrades/upgrade-28.0.0/bin/osmosisd version
```
