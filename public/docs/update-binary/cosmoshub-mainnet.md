...
```bash
mkdir -p $HOME/.cosmoshub/cosmovisor/upgrades/upgrade-19.0.0/bin
```
...
tar -xzf cosmoshubd.tar.gz
chmod +x cosmoshubd
mv cosmoshubd $HOME/.cosmoshub/cosmovisor/upgrades/upgrade-19.0.0/bin/
```

### 3. Verify Binary

```bash
$HOME/.cosmoshub/cosmovisor/upgrades/upgrade-19.0.0/bin/cosmoshubd version
```
