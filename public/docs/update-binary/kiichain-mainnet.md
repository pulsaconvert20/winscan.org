...
```bash
mkdir -p $HOME/.kiichain/cosmovisor/upgrades/upgrade-1.0.0/bin
```
...
tar -xzf kiichaind.tar.gz
chmod +x kiichaind
mv kiichaind $HOME/.kiichain/cosmovisor/upgrades/upgrade-1.0.0/bin/
```

### 3. Verify Binary

```bash
$HOME/.kiichain/cosmovisor/upgrades/upgrade-1.0.0/bin/kiichaind version
```
