...
```bash
wget -O $HOME/.atomone/config/genesis.json https://server-3.itrocket.net/mainnet/atomone/genesis.json
```

# Download addrbook

```bash
wget -O $HOME/.atomone/config/addrbook.json  https://server-3.itrocket.net/mainnet/atomone/addrbook.json
```
