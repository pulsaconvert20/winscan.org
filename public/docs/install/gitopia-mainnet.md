...
```bash
curl -Ls https://data.winsnip.xyz/list/mainnet/gitopia/genesis.jsons > $HOME/.gitopia-mainnet/config/genesis.json
```

# Download addrbook

```bash
curl -Ls https://data.winsnip.xyz/list/mainnet/gitopia/addrbook.json > $HOME/.gitopia-mainnet/config/addrbook.json
```
